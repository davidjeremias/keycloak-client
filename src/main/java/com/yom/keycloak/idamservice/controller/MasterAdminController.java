...
public class MasterAdminController {
    ...
    @PostMapping(path = "/lo", consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
    public AccessTokenResponse getTokenNew(@RequestBody Map<String, Object> credentials) {
        Keycloak kc = Keycloak.getInstance(
                serverUrl,
                (String) credentials.get("company"),
                (String) credentials.get("username"), (String) credentials.get("password"),

package com.yom.keycloak.idamservice.serv;
...
public class KeycloakClientAuthExample {
	  ...
	  public static void main(String[] args) {
	    ...
	    KeycloakClientFacade facade = new KeycloakClientFacade( //
	      "https://auth-tes.camara.gov.br/auth" //
	      , "gabinetedigital" //
	      , "sivis2-frontend" //
	      , "dc3a9367-ab7c-45a1-af01-c21bb2caeb83" //
	    );
...
//	    System.out.println(facade.getAccessToken());
	    ...
	    AccessToken accessToken = facade.getAccessToken("p_6677", "123");
